...
export async function cleanDatabase() {
  ...
  await prismaTest.privacyAuditEvent.deleteMany()
  await prismaTest.dataSubjectRequest.deleteMany()
  await prismaTest.privacyPreference.deleteMany()
  await prismaTest.userLegalAcceptance.deleteMany()
  await prismaTest.legalDocumentVersion.deleteMany()
